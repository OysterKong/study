...
public class TestController {
		...
		@RequestMapping(value="/login", params = "aaa=bbb")	//param이 일치하는 경우
		...
		@RequestMapping(value="/login", params = "aaa=ccc")	//param이 일치하는 경우
		public String login() {
		...
		@RequestMapping(value="/login", params = "xxx")	//param이 일치하는 경우
