...
public class GoodsController {
	...
	public String delAllCart(@RequestParam("check") ArrayList<String> list) throws Exception { //String [] check 도 가능
	...
	public String cartList(RedirectAttributes attr, HttpSession session) throws Exception { //RedirectAttribute 사용시에는 servlet-context.xml에 annotation-driven이 꼭있어야함
