...
$(document).ready(function(){
	   ...
	   $("#cart").on("click",function(){
		   ...
		   if($("#gSize").val()=="사이즈선택"){
	  		...
	  		$("form").attr("action", "loginCheck/cartAdd");  // form 의 action 속성을 loginCheck/cartAdd 로 변경
	  		 }); //// 아이디 cart (장바구니버튼) 클릭시 유효성 검사 후 loginCheck/cartAdd 으로 데이터 전달
